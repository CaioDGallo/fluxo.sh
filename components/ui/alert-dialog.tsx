...
function AlertDialog({
  ...
  return (
    <AlertDialogContext.Provider value={{ onOpenChange }}>
      <AlertDialogPrimitive.Root data-slot="alert-dialog" onOpenChange={onOpenChange} {...props} />
