...
export const DEFAULT_CATEGORIES: DefaultCategory[] = [
  ...
  { name: 'Transporte', color: '#3b82f6', icon: 'Car01Icon', type: 'expense', bucket: 'necessities', isImportDefault: true },
  { name: 'Entretenimento', color: '#a855f7', icon: 'GameController01Icon', type: 'expense', bucket: 'wants', isImportDefault: false },
  { name: 'Compras', color: '#f97316', icon: 'ShoppingBag01Icon', type: 'expense', bucket: 'wants', isImportDefault: true },
  ...
  { name: 'Contas', color: '#78716c', icon: 'ElectricHome01Icon', type: 'expense', bucket: 'necessities', isImportDefault: true },
